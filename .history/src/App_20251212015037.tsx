...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Hide figures and buttons immediately, then whiteout -> next image.
    setShowFigures(false);
    setShowButtons(false);
    setWhiteout(true);
    ...
    const nextTimer = window.setTimeout(() => {
      ...
      setWhiteout(false);
      // kick off the sequence after faces shows
      setSequenceIndex(-1);
    }, 3000);
  ...
  useEffect(() => {
    ...
    if (sequenceIndex === -1) {
      ...
      timer = window.setTimeout(() => setSequenceIndex((idx) => (idx === null ? null : idx + 1)), 1500);
    }
