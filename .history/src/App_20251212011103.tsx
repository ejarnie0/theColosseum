            ...
            <div className="story-card">
              ...
              {pathChoice && (
                <div className="story-note">
                  {pathChoice === 'faster' && 'You hold your breath. The shuffling stops—something knows you are there.'}
                  {pathChoice === 'slower' && 'Each step echoes. The wind swells, pushing you forward as if guiding you.'}
                </div>
              )}
            </div>
          </div>
