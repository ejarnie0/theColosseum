...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (sequenceIndex === -1) {
      ...
      // sequence ended; reveal final buttons
  ...
  useEffect(() => {
    ...
    if (postStatuesIndex < lines.length - 1) {
      ...
      // finished post-statues lines; show final buttons
      setShowButtons(true);
      setShowFinalButtons(true);
    }
    ...
    ((displayImage === faces || displayImage === handsReaching) && sequenceIndex !== null && sequenceIndex >= 0
      ...
      : postStatuesIndex !== null
        ? [
            ...
            'While we, those that cannot see,',
            'Cast our eyes down, and bear witness to the.'
          ][postStatuesIndex] ?? 'Cast our eyes down, and bear witness to the.'
